...
The old REX-ISOLDE post-accelerator was limited to a beam energy of 2.85 MeV/u for \Sm, which gave a low Coulomb excitation cross section and a low probability for multi-step excitations. 
Therefore, a secondary target of $^{94}$Mo with a thickness of 2 mg/cm$^2$ was chosen to maximize the cross section at this energy.
...
In the experiment, previously unknown transition strengths between low-lying states in \Sm\ was extracted. 
...
In 2017, with a upgrade of the ISOLDE facility, beam energies up to 7.5 MeV/u could be delivered.

This implies that we can choose a high-$Z$ target (Pb) to give high COULomb EXcitation (COULEX) cross section, especially for multi-step. 
A beam energy of 4.7 MeV/u was chosen as the highest possible energy for safe COULEX for Pb.
Safe COULEX is the distance of closest approach large enough to exclude nuclear interaction.

This allows Coulomb excitation of \Sm\ at higher energies than the previous experiment.
Excited states up to at least the $6^+$ state at 2082 keV are expected to be populated.
...
With a new experiment, it will also be easier to interpret the shape of \Sm.
...
\Sm\ is a radioactive isotope with a half-life ($T_{1/2}$) of 14.82 min. 
...
\begin{figure}[htb]
	...
	\caption{Sm shape transitions based on \cite{Hilaire2007, CEA}. 
	\textcolor{red}{Denne figuren hører til \autoref{fig:cea_CoN}}.}
	\label{fig:Sm-shapes}
\end{figure}
...
the basics of Coulomb excitation (COULEX)
