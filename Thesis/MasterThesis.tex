...
In nuclear physics, an analogy to the atomic shell model is used to explain nuclear structure, the nuclear shell model \cite{Krane}. 
...
An extensive description of the nuclear shell model can be found in \cite{Krane}.




This thesis will not go into details about the liquid drop model, the nuclear shell model or other nuclear model, because there is no comparison of the data to any theoretical models.
...
The liquid drop model is explained extensively in \cite{Krane}.

\textcolor{red}{er alle magiske mer stabile, eller finnes det unntak her? mener å huske det var en diskusjon om dette på pauserommet på kjernefysikk en gang, men husker ikke hva konklusjonen var.}
...
\begin{figure}[ht]
	...
	\caption{Collective excitations / Potential surface for \Sm, adapted from \cite{Hilaire2007, CEA}. \textcolor{red}{\Sm\ looks like a so-called \ga-soft vibrator? See lecture FYS4570 18. Sept 2018.}}
	\label{fig:cea_tri}
\end{figure}
