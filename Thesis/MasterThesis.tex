...
%First of all, I would like to thank my supervisors for giving me the amazing opportunity to work in fundamental research. Professor Andreas Görgen and Dr. Katarzyna Hady{\'{n}}ska-Kl{\c{e}}k, thanks for the good advices, help, and enriching ideas you provided.

%A special thanks to Andreas for being available for weekly meetings to answer all my questions.
...
In future work, the \ga-\ga\ matrix can be utilized to search for new transitions to extend the level scheme of \Sm.
...
Since the present experiment provides many more data points compared to the number of free parameters, the experiment (IS558) will provide both transitional and diagonal matrix elements with good precision. 
