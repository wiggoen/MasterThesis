...
In \autoref{fig:gam_dcB} there is a visible enhanced efficiency for high-energy \ga-rays when using the add-back method. \textcolor{red}{Jeg ser ikke helt hvor mye bedre det blir. Jeg ser at det er tydelig høyere counts rundt 800-1400 keV, og at toppene kanskje kommer litt tydeligere frem.}
...
A lot of the \ga\ transitions in \autoref{fig:levels} are visible in the \autoref{fig:gam_dcB}. 
%marked by the black arrows.
The black arrows marks the \ga\ transitions.
The green arrows marks some of the energy states in the level scheme, this is a combination of two \ga\ transitions, i.e. a summing of the peaks.
...
At very low energy, below the Compton continuum, a peak of \Pb\ x-rays is visible. 
...
The $2_2^+ \rightarrow 2_1^+$ (460 keV) transition corresponds to the transition from the 990 keV to the 531 keV state. 

The $0_2^{(+)} \rightarrow 2_1^+$ (1068 keV) transition corresponds to the transition from the 1599 keV to the 531 keV state. 
...
From the present experiment at ISOLDE, IS558 in 2017, it was expected that excited sates up to $8^+$ are populated. 
