...
\begin{align*}
	2, ~8, ~20, ~28, ~50, ~82, ~126
\end{align*}
They are one of the main features that shell structure is built upon. Maria Goeppert Mayer discovered them around 1945 from observation of periodicity in binding energy. She gave W. Elsasser credits for being the first to remark that such numbers exists, as early as 1933. Eugene Wigner believed in the liquid drop model and did not trust the new theory. He called these numbers "magic" \cite{Mayer1964, MIT-OCW}. 
