...
One of the best examples for shape coexistence is the mercury (Hg) isotopes around the isotope $^{186}_{~80}$Hg$_{106}$. 
% at neutron mid shell,
With a proton number of $Z = 80$, the Hg isotopes are just below the proton shell closure, $Z = 82$, and at neutron mid shell.
