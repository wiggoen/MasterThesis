...
\textcolor{red}{----------}\newline
\textcolor{red}{Does this belong to chapter 3?}\newline
...
After the Doppler correction the \texttt{CLXAna} program needs to be used in order to get the Doppler-corrected \ga-spectra to analyze the Coulomb excitation of \Sm.
...
As mentioned in \autoref{ssec:user_cal}, the output from \texttt{Q4S.sh} using \texttt{TreeBuilder} was: WeightPR: 0.75.
