...
I would like to thank my supervisors Professor Andreas Görgen and Dr. Katarzyna Hady{\'{n}}ska-Kl{\c{e}}k for giving me the amazing opportunity to do an experiment at CERN-ISOLDE. 
...
For instance, a neutron deficient isotope may have a different shape than a neutron rich isotope.
...
% is possible for certain regions of $N$ and $Z$.
...
In 2012, another Coulomb excitation experiment of \Sm, IS495, was conducted at CERN-ISOLDE. 
The experimental setup at the time was limited to a beam energy\footnote{Beam energies are usually given in keV/u or MeV/u. This originates from MeV/A = MeV/A $\cdot$ A/u = MeV/u. The conversion factor is 1 A = 1 u $\implies$ 1 = A/u, where $A$ is the mass number of the nucleus and $u$ is the atomic mass unit.} of 2.85 MeV/u for \Sm, which gave a lower Coulomb excitation cross section and a lower probability for multi-step excitations, compared to the present experiment. 
...
The current experiment is an extension to the previous experiment. 
...
In turn, this implied that it was possible to choose a high-$Z$ target (\Pb) to give a high Coulomb excitation cross section, especially for multi-step excitations.
...
This will give a greater understanding of the nuclear structure in \Sm.
...
%It is expected to measure the intensities of the known \ga\ transitions. 
%in \Sm\ to better understand the structure of this nucleus.
...
Another goal is to make the procedure of a data analysis code named \textsl{MiniballCoulexSort} more transparent.
...
method. 
The ISOLDE facility and the experimental setup utilized to extract particle gamma coincidences will be presented in \autoref{ch:experiment}. 
By means of the analysis code named \textsl{MiniballCoulexSort}, the data was sorted and calibrated, as explained in in \autoref{ch:DA}.
In \autoref{ch:results}, the resulting Doppler corrected \ga\ spectrum is presented.
\autoref{ch:SO} summarizes of the thesis and outlines the future work of the Coulomb excitation analysis of \Sm. 
...
%The primary target is on a 60 kV high voltage platform.
...
%, in addition to an unknown state which will be discussed below, in the current section. 
...
%When considering the detection of either projectile, target, or for some angles both, 
...
Since the present experiment (IS558) provides many more data points compared to the number of free parameters, the experiment will provide both transitional and diagonal matrix elements with good precision. 
...
%In addition, the experimental input includes the transition strengths 
%%of the $2_1^+ \rightarrow 0_1^+$, $4_1^+ \rightarrow 2_1^+$, and $2_2^+ \rightarrow 2_1^+$ 
%from the previous experiment (IS495) and a few known \ga-ray branching ratios. 
...
\begin{table}[ht] 
    \centering 
    \caption{}
	\input{Table-data/Participants.tex}
...
\bibliography{/Users/trondwj/GitHub/MasterThesis/Thesis/References/Mendeley-decoupled.bib,/Users/trondwj/GitHub/MasterThesis/Thesis/References/web_references.bib}
