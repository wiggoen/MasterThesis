...
ISOLDE is a radioactive ion beam facility at CERN in Meyrin, Switzerland. The facility can produce over 1000 different radionuclides to be used in a wide variety of experiments in nuclear physics, atomic physics, solid state physics, life sciences and fundamental interactions. Experiments have been performed at ISOLDE since 1967 and since 2001 experiments with post-accelerated radioactive ion beams (RIBs) have been conducted. \textcolor{red}{New / moved facility in 1992, to the place as we know it today.} The high intensity and energy upgrade (HIE-ISOLDE) have made it possible to deliver energies up to 10 MeV/$u$ in 2018 \cite{HIE-ISOLDE}. 
...
\begin{figure}[ht]
	...
	\caption{Coulex ISOLDE. Adapted from Malin Klintefjord}
	\label{fig:Coulex}
\end{figure}
