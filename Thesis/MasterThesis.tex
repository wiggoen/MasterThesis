...
A visualization of the known \ga\ transitions in \autoref{tab:gamma_trans} are displayed in \autoref{fig:levels}. 
...
\textcolor{red}{Introduser gamma-gamma matrisen, og så coincidence spectra.}\newline
...
\autoref{fig:check_state} shows a coincidence spectra of \textcolor{red}{??? hvordan presentere denne figuren ???}.
...
\textcolor{red}{Koble B(E2) mot \autoref{fig:projections}.}
