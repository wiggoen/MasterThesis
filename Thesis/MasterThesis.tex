...
\textcolor{blue}{The primary target is on a 60 kV high voltage platform} \textcolor{red}{??? Hva betyr dette? Er det viktig? ???} \cite{ISOLDE-web, TIF}. 
...
REXTRAP is a penning trap which \textcolor{red}{??? has the tasks of / tasks are ???} accumulation, bunching and cooling of the RIB \cite{HIE-ISOLDE, REXTRAP1, REXTRAP2}. 
...
Therefore, \textcolor{red}{??? there is / it is / there are ???} a small probability of observing the first excited state of \Pb\ in the \ga-spectrum. 
...
The radial strips cover a wide angular range, thus they show no sharp peaks.
...
\begin{table}[ht] 
    \centering 
    \caption{The mid ring CD angles in the LAB frame, with a distance from the target to the CD of 26.98 mm. 
...
As \autoref{fig:cal_FB} shows, the calibration of the CD got better by removing the innermost ring. 
