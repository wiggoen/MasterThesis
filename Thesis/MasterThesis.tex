...
\textcolor{blue}{Du trenger ikke forklare det i detalj, men du kan kanskje si at en lav-liggende $2_2^+$ tilstand er et tegn for trixialitet, som kan enten være statisk eller dynamisk. Ut fra energien til $2_2^+$ tilstanden og $B(E2; 2_2^+ \rightarrow 2_1^+)$ verdien kan man ikke bestemme om den triaxiale deformasjonen er statisk eller dynamisk, men informasjon om $3_1^+$ tilstanden kan hjelpe å finne ut.}
