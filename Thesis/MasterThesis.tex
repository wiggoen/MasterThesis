...
%\footnote{Beam energies are usually given in keV/u or MeV/u. This originates from MeV/A = MeV/A $\cdot$ A/u = MeV/u. The conversion factor is 1 A = 1 u $\implies$ 1 = A/u, where $A$ is the mass number of the nucleus and $u$ is the atomic mass unit.}
...
\Sm\ has therefore a transitional character between spherical and deformed shape.
