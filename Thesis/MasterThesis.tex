...
* skriv litt generelt om ISOL-teknikken (radioactive target not possible)

\subsection{Beam production}
A proton beam of 1.4 GeV ($\sim 10^{18}$ protons) from the PSB comes into the ISOLDE facility and collide with a production target \textcolor{purple}{of tantalum, producing the elements in the chart of nuclides up to tantalum.}


* kan gjerne forklare figuren litt mer. I vårt tilfelle bruker vi tantalum, ikke for alle reaksjoner. Fragmentation er viktig å nevne
