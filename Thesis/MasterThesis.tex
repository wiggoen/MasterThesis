...
%The energy is usually given in $\frac{\text{keV}}{\text{u}}$ or $\frac{\text{MeV}}{\text{u}}$.
%This comes from 
%\begin{align}
%	\frac{\text{MeV}}{\text{A}} &= \frac{\text{MeV}}{\text{A}}  \frac{\text{A}}{\text{u}} = \frac{\text{MeV}}{\text{u}}  &  1 ~\text{A} &= 1 ~\text{u} \implies 1 = \frac{\text{A}}{\text{u}}
%\end{align}
...
If the threshold is set too low, pedestal events are included in the \textcolor{red}{??? spectra / other stuff / Coulex something ???} and it will get things wrong. \textcolor{red}{Jeg vet ikke hva som går galt, dette var forklaringen jeg fikk.....:(}
...
\begin{figure}[htb]
	...
	\caption{Total statistics for \ga-rays, background subtracted, Doppler corrected for scattered projectile. The blue curve is sorted with singles, and the red curve is sorted with add-back. The green arrows marks some of the energy levels in the level scheme.}
	\label{fig:gam_dcB}
\end{figure}
