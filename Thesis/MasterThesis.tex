...
\textcolor{red}{MORE INPUT HERE!}

After the sorting, I moved the file to a folder of sorted data, and gave the relative path in the setup\_Sm.txt file used as input in the MultiPlot.cpp script. 
...
root [1] check_ADC_time_offsets("setup_Sm.txt", "user")
\end{lstlisting}
