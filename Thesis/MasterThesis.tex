...
\end{lstlisting}
\textcolor{red}{Må kanskje henvise til appendix her, siden jeg flytta forklaringen?}\newline
%A detailed explanation of the input parameters is in \autoref{ch:cd_sim}.
...
Therefore, the relative intensity between the projectile and target peaks are not identical to the values in the experiment.
Nonetheless, the simulated energies are realistic.

For stopping powers are \texttt{kinsim3} applying SRIM-2013 \cite{SRIM} generated files relevant to the reaction with some random spread.
...
\end{lstlisting}
\textcolor{red}{Appendix-materiale det her også egentlig?}
