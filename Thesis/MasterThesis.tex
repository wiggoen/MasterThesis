...
In 1909, the famous Rutherford experiment took place.
The experiment was the bombardment of $\alpha$-particles into a gold (metal) foil, to observe how the particles scattered.
Rutherford and his helpers, Hans Geiger and Ernest Marsden, expected the particles to pass straight through, with little deflection. 
...
As late as 1932, the neutron was discovered. 
...
SI is The International System of Units, which is built upon seven base units.
...
\Sm\ ($T_{1/2} = 14.82$ min), Lanthanide from the periodic table.
