...
\texttt{CLXAna} perfomed a kinematic reconstruction and applied a Doppler correction of the \ga-ray spectra.

\textcolor{red}{\ga-spectra med transitions..}
...
A \ga-\ga\ matrix was produced, which could be analyzed to search for new transitions and extend the level scheme. 
...
Look for an updated version of \textsl{MiniballCoulexSort} and ask Dr. Liam Gaffney if there are any new considerations of how to use it with the data set from 2017.

Very pure beam, but should in the future analysis check for possible beam contaminants. 
Check beam composition from laser on/off data.
Look at the \ga-spectra to identify possible beam contaminants.
There may be a little bit of $^{140}$Nd in the beam, but if so, it is very little (judging from on-line spectra).
...
It is always possible to improve the calibration. 
\textcolor{blue}{If you have concrete suggestions of what could be improved, you can of course mention these. My feeling is that it would take a major effort to make even small improvements, so most likely we will continue further with the GOSIA analysis with the spectra that you have produced.} \newline
...
This is the experimental input into a Coulomb excitation codes named GOSIA \cite{GOSIA}.
Other experimental inputs are the transition strengths of the $2_1^+ \rightarrow 0_1^+$, $4_1^+ \rightarrow 2_1^+$, and $2_2^+ \rightarrow 2_1^+$ from the previous experiment with their uncertainties, and a few \ga-ray branching ratios that are known. 
