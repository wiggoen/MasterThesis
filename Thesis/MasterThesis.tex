...
\subsection{Particle detector calibration}
...
The simulations are theoretical predictions of energy used in the calibration.
...
\chapter{CD simulation}
On the next page, the CD simulation is showed for each ring. Ring 1 is the innermost ring and ring 16 is the outermost ring. The plots show simulated counts vs. energy.
