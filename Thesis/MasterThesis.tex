...
When the beam particle approaches the target particle, the beam particle reaches a minimum separation distance which is dependent on $b$. 
In a head-on collision, $b = 0$ and the particles reach the distance of closest approach. 
In safe COULEX, the distance of closest approach is chosen by 
\begin{equation}
	d > R_b + R_t + d_s = 1.25 (A_b^{1/3} + A_t^{1/3}) + 5~\text{[fm]}
\end{equation}
...
\begin{equation}
	\eta = \frac{b}{2\lambdabar} = \frac{Z_p Z_t e^2}{\hbar \nu}
\end{equation}
