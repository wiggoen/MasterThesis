...
\textcolor{red}{Finn plassering og lag mer kontekst.}\newline
...
The spin and parity of the 990 keV \cite{Firestone} state was originally assumed to be $0^+$, and $2^+$ for the 1599 keV state. \textcolor{red}{Flytt ref til slutten av setningen? Har egentlig bare ref for 990 keV..}
